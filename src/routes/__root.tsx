...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "احجز مقعدك في نقل مشترك من وإلى المطارات في مصر ولبنان بسعر ثابت ومواعيد معروفة.",
      },
      { name: "author", content: "GoAir" },
      { property: "og:title", content: "GoAir — نقل مشترك من وإلى المطار" },
      {
        property: "og:description",
        content: "سعر ثابت لكل مقعد، مواعيد معروفة، ومندوب باسمك في صالة الوصول.",
      },
      ...
      { name: "theme-color", content: "#5B2EFF" },
      { name: "mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-capable", content: "yes" },
      { name: "apple-mobile-web-app-status-bar-style", content: "black-translucent" },
      { name: "apple-mobile-web-app-title", content: "GoAir" },
    ],
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Changa:wght@600;700;800&family=IBM+Plex+Sans+Arabic:wght@400;500;600&display=swap",
      },
      {
        rel: "stylesheet",
        href: appCss,
  ...
  useEffect(() => {
    ...
    if ("serviceWorker" in navigator) {
      navigator.serviceWorker.register("/sw.js").catch(() => {
        // Offline shell is a nice-to-have — never block the app if it fails to register.
      });
    }
  }, []);
