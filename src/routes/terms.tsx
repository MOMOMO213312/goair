...
import { termsContent, type LegalBlock } from "@/lib/i18n/legal-content";
import { useTranslation } from "@/lib/i18n/language-context";
import { translations, DEFAULT_LANGUAGE } from "@/lib/i18n/translations";

const pageMeta = translations[DEFAULT_LANGUAGE].termsPage.meta;
  ...
  return (
    <div className="bg-mist/30 pb-16 pt-10 sm:pt-14">
      <div className="mx-auto max-w-3xl px-4">
        <SectionHeader title={t("termsPage.title")} description={t("termsPage.lastUpdated")} />

        <LegalDraftNotice text={t("termsPage.draftNotice")} />
