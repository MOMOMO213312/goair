...
// كل محافظات مصر (بمدينتها الرئيسية) ومحافظات لبنان الأساسية — قائمة شاملة
// للدولتين، مش مقتصرة على مدن رحلات المطار الأربعة الحالية بس، عشان مزوّدي
// التأجير في أي مدينة يقدروا يسجلوا بيانات دقيقة من الأول.
export const RENTAL_CITIES_BY_COUNTRY: Record<string, string[]> = {
  مصر: [
    "القاهرة",
    "الجيزة",
    "الإسكندرية",
