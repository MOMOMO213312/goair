...
const en = {
  ...
  footer: {
    ...
    joinTransport: "Join Shared Transport With Your Vehicle",
  ...
  joinTransportPage: {
    meta: {
      title: "Join Shared Transport With Your Vehicle — GoAir",
      description:
        "Own a van, Hiace or minibus? Register your vehicle to join GoAir's shared transport network after our team reviews it.",
    },
    title: "Join Shared Transport With Your Vehicle",
    subtitle:
      "Own a van, Hiace or bus? Register your details here — our team will review your request and reach out to activate your transport partner account.",
    ...
    reviewNote:
      "This is not a login account. GoAir will review your details and contact you; we'll ask for photos of your licenses and insurance after initial approval. Your vehicle starts receiving trips once its documents are approved.",
    submit: "Submit Request",
    missingFields:
      "Complete your name, phone, country, vehicle type, plate number and the license/insurance dates.",
