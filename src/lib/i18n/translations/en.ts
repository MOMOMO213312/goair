...
const en = {
  ...
  footer: {
    ...
    joinTransport: "Join the Shared Transport Network",
  ...
  joinTransportPage: {
    meta: {
      title: "Join the Shared Transport Network — GoAir",
      description:
        "Own a van, Hiace or run a transport company? Create your account and apply to join GoAir's shared transport network.",
    },
    title: "Join the Shared Transport Network",
    subtitle:
      "Create your account and apply — GoAir reviews your details, and once approved the same login opens your partner portal, no extra steps.",
    ...
    authMissing: "Enter your email and password.",
    passwordShort: "Password must be at least 8 characters.",
    passwordMismatch: "Passwords do not match.",
    authError: "We couldn't complete that.",
    confirmEmailTitle: "Confirm your email",
    confirmEmailBody:
      "We sent you a confirmation email. Open it, then come back here and sign in to finish your application.",
    signedInAs: "Signed in as",
    signOut: "Sign out",
    providerTypeLabel: "I am…",
    typeIndividual: "A vehicle owner (individual)",
    typeCompany: "A transport company",
    ownerSection: "Contact person",
    companySection: "Company details",
    vehicleSection: "Vehicle details",
    docsSection: "Licenses & insurance",
    nameLabel: "Full name",
    phoneLabel: "Mobile number",
    countryLabel: "Country",
    countryPlaceholder: "Select country",
    ...
    commercialRegLabel: "Commercial registration number",
    taxNumberLabel: "Tax number (optional)",
    fleetSizeLabel: "Approximate fleet size",
    companyFleetNote:
      "After approval you'll add your vehicles and drivers from the partner portal; each vehicle goes live once its documents are reviewed.",
    vehicleTypeLabel: "Vehicle type",
    vehicleTypePlaceholder: "Select vehicle type",
    seatsSuffix: "seats",
    plateLabel: "Plate number",
    carMakeModelLabel: "Make & model",
    carMakeModelPlaceholder: "e.g. Toyota Hiace",
    carYearLabel: "Year",
    hasDriverLicenseLabel: "I will drive the vehicle myself (I hold a valid driving license)",
    notDriverHint: "No problem — we'll contact you to arrange a driver.",
    licenseNumberLabel: "Driving license number",
    licenseExpiryLabel: "Driving license expiry date",
    registrationExpiryLabel: "Vehicle registration expiry date",
    insuranceExpiryLabel: "Insurance expiry date",
    nationalIdLabel: "National ID / ID number (optional)",
    notesLabel: "Any extra details",
    notesPlaceholder: "Routes you work on, availability, etc.",
    reviewNote:
      "After approval we'll ask for photos of your licenses and insurance. Any vehicle or driver only goes live once its documents are reviewed.",
    submit: "Submit Request",
    missingFields: "Complete your name, phone, country and the other required fields.",
    missingVehicleFields: "Complete the vehicle type, plate number and the license/insurance dates.",
    missingCompanyFields: "Complete the company name, commercial registration number and fleet size.",
    licenseMissing: "Enter your driving license number and expiry date.",
    expiredDates: "License and insurance expiry dates must be in the future.",
    sendError: "We couldn't send the request.",
    statusPendingTitle: "Your request is under review",
    statusPendingBody:
      "The GoAir team is reviewing your details and will contact you soon. You can return to this page with your account any time to check the status.",
    statusApprovedTitle: "Your request was approved",
    statusApprovedBody: "Your account is now a transport partner. Open the partner portal with the same email and password.",
    statusApprovedCta: "Open partner portal",
    statusRejectedTitle: "Your request was not approved",
    statusRejectedBody: "You can update your details and submit a new request using the form below.",
  },
  rentACarPage: {
    meta: {
    ...
    mileageLimited: "{{km}} km/day",
    insuranceIncluded: "Full insurance included",
    insuranceNotIncluded: "No insurance",
