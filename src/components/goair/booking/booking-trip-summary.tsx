  ...
  return (
    ...
    >
      ...
      <div className="p-5 sm:p-6">
        <p className="text-xs font-bold uppercase tracking-wide text-muted-foreground">{t("booking.tripSummary.label")}</p>
        ...
        <div className="mt-4 flex items-center gap-3">
          <div className="text-center">
            <p className="text-[10px] font-bold text-muted-foreground">{t("booking.tripSummary.airport")}</p>
          ...
          <div className="max-w-[7rem] text-center">
            <p className="text-[10px] font-bold text-muted-foreground">{t("booking.tripSummary.destination")}</p>
        ...
        <dl className="mt-5 space-y-3 text-sm">
          ...
          <div className="flex items-center justify-between gap-3">
            <dt className="inline-flex items-center gap-1.5 text-muted-foreground">
              ...
              {t("booking.tripSummary.departureTime")}
            </dt>
          ...
          <div className="flex items-center justify-between gap-3">
            <dt className="inline-flex items-center gap-1.5 text-muted-foreground">
              ...
              {t("booking.tripSummary.seats")}
            </dt>
            <dd className="font-bold text-primary">
              {seats} {seats === 1 ? t("booking.tripSummary.seatSingular") : t("booking.tripSummary.seatPlural")}
            </dd>
          </div>
        </dl>
        ...
        {fallback ? (
          <div className="mt-4 space-y-2 rounded-lg border border-border bg-secondary/40 p-3">
            <span className="inline-block rounded-md border border-border bg-background px-2 py-0.5 text-[10px] font-medium">
              {t("booking.tripSummary.referenceSchedule")}
            </span>
            <p className="flex items-start gap-1.5 text-xs text-muted-foreground">
              <Info className="mt-0.5 size-3.5 shrink-0" aria-hidden />
              {t("booking.tripSummary.referenceNote")}
            </p>
          </div>
        ) : null}
      </div>
